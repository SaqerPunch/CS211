...
void recursiveMatTrans (
	...
	int off = n / 2 ;
        recursiveMatTrans ( global_n, off, A, offset_row_A      , offset_col_A      , B, offset_row_B      , offset_col_B);
	recursiveMatTrans ( global_n, off, A, offset_row_A      , offset_col_A + off, B, offset_row_B + off, offset_col_B);
	recursiveMatTrans ( global_n, off, A, offset_row_A + off, offset_col_A      , B, offset_row_B      , offset_col_B + off);
	recursiveMatTrans ( global_n, off, A, offset_row_A + off, offset_col_A + off, B, offset_row_B + off, offset_col_B + off);
        /* ... */
        /* ... */
        /* ... */
    }
